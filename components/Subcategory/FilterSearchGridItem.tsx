...
const FilterSearchGridItem = ({ data, data2, data3 }: Props) => {
  ...
  const { data: productData } = useGetProductBySearch(data);
  ...
  const FinalData =
    categoryFilterItem?.length > 0 ? filterProduct?.data : productData;
                              ...
                              <li className={styles2.checkboxstyle}>
                                ...
                                <div>
                                  <span className={styles2.SpanClass}>
                                    I agree to{" "}
                                    <a className={styles2.TermsColor}>
...
export default FilterSearchGridItem;
