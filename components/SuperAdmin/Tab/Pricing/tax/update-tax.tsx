...
const UpdateTax = ({ currentId, setSubTab }: serviceProps) => {
  ...
  const handleSubmit = React.useCallback(
    ...
    [benifits, currentId, data, mutate, name, price, quantity, rate, type, unit]
  );
          ...
          <div className={styles.inputFlex}>
            <div className={styles.inputbox}>
              ...
              <input
                ...
                // value={quantity}
                defaultValue={currentId?.quantity}
