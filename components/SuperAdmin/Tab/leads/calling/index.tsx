...
const Email = () => {
  ...
  const { data: QueryData } = useBuyerQuerySuperAdmin();
  ...
  const EmailLeads = QueryData?.data?.filter(
    (item: any) => item.type == "Calling Query"
  );
                ...
                >
                  <tbody>
                    <tr className={styles.Thead}>
                      ...
                      <th className={styles.Thead}>Buyer Mob</th>
                      <th className={styles.Thead}>Buyer Message</th>
