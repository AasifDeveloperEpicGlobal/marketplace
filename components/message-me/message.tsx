...
import ThirdEditScreen from "./screens/thirdedit";
import SecondEditScreen from "./screens/secondedit";
      ...
      case 5:
        return (
          <SecondEditScreen
            handleState={(value) => setSecondScreenValues(value)}
            // isNext={(value) => setIsNext(value)}
            value={secondeditScreenValues}
            handleStep={(value) => setCurrentStep(value)}
            isNext={function (value: boolean): void {
              ...
              >
                ...
                <ul className={styles.modelpoptabstyle}>
                  <li className={currentStep === 0 ? styles.active : ""}>
                    {" "}
                    <Link href="#">
                      <span style={{ color: "" }}>Create Account</span>
                    </Link>{" "}
                  </li>
                  <li className={currentStep === 1 ? styles.active : ""}>
                    {" "}
                    <Link href="#">Business Details</Link>{" "}
                  </li>
